<%-- 
    Document   : dashboard
    Created on : 21 Feb, 2019, 11:47:34 AM
    Author     : HP
--%>
                ...
                <div class="menu-sidebar__content js-scrollbar1">
                    <nav class="navbar-sidebar">
                        <ul class="list-unstyled navbar__list">
                            ...
                            <li>
                                <a href="addsp.html">
                                    <i class="far fa-check-square"></i><b>Authorized Organizations</b></a>
                            </li>
                    ...
                    <div class="section__content section__content--p30">
                        <div class="container-fluid">
                            <div class="header-wrap">
                                <form class="form-header" action="googlereDirect" method="POST">
